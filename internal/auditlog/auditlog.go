...
const (
	...
	ActionIosDeviceInvitationRevoked        Action = "ios_device_invitation.revoked"
	ActionIosDeviceRegistered               Action = "ios_device.registered"
	ActionIosDeviceDisabled                 Action = "ios_device.disabled"
	ActionIosDeviceEnabled                  Action = "ios_device.enabled"
